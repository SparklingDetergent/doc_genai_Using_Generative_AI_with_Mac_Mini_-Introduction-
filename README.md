...
- いったん回答が終わったら、「フェーズ○○以降、続けて」と入力し実行してみましょう。

<br/><br/>
#### コード生成の具体例：Powershellスクリプト作成
- **プロンプト:** Powershellでファイル又はフォルダの削除処理を実装してください。フェーズ１から順に前のフェーズを引き継ぐ形で完成度を高めるものとします。

<br/><br/>
#### 文章生成の具体例：生成AI導入資料作成
- **プロンプト:** 生成AIの導入資料を作成してください。フェーズ１から順に前のフェーズを引き継ぐ形で完成度を高めるものとします。
